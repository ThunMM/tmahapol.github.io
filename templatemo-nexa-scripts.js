...
function sendMail() {
    ...
    // 2. Define the receiving email address
    const toEmail = userEmail;

    // 3. Format the body text to include the sender's name and email
    const emailBody = `Dear Dr Thunyapong Mahapol,\n\n${message}\n\nYours faithfully,\n${name}`;

    // 4. Construct the mailto URL with proper encoding
